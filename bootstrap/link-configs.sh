...
link "$REPO_ROOT/configs/zellij/config.kdl"                  "$HOME/.config/zellij/config.kdl"
link "$REPO_ROOT/configs/zellij/layouts/polysimulator.kdl"   "$HOME/.config/zellij/layouts/polysimulator.kdl"
